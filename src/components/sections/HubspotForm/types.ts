...
export interface HubspotFormProps {
   ...
   */
  readonly onBeforeFormInit?: () => void;
  /**
   ...
   */
  readonly onFormReady?: ($form?: HTMLFormElement) => void;
  /**
  ...
  readonly onFormSubmit?: (
    ...
    formValues?: { name: string; value: unknown }[],
  ) => void;
  /**
  ...
  readonly onFormDefinitionFetchError?: (res: unknown) => void;

  readonly onFormFailedValidation?: ($form?: HTMLFormElement) => void;

  readonly onFormError?: (
    errorCode: string,
    _: unknown,
    values: { id: string; value: unknown; errors: string[][] }[],
  ) => void;
}
...
export interface Hbspt {
  forms: {
    create: (props: HubspotFormProps) => void;
